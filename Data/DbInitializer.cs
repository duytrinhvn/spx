    ...
    public static class DbInitializer
    {
        ...
        public static async Task<int> SeedData(IServiceProvider serviceProvider)
        {
            ...
            if (!context.Teams.Any())
            {
                ...
                var bundesliga_league = (from league in context.Leagues
                                     where league.Name == "Bundesliga"
                                     select league).FirstOrDefault();
                var soccer_sport = (from sport in context.SportCategories
